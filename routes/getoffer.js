...
exports.getoffers = function(req, res) {
	...
	console.log(auth);
	request
	   .get('http://10.32.0.254:8080/IMS-war/resources/hello/offers')
...
exports.filter = function(req, res) {
	...
	//post
	request
	   .post('http://10.32.0.254:8080/IMS-war/resources/hello/finaloffers')
...
/*	var resp = {
	...
	//post
	request
	   .get('http://10.32.0.254:8080/IMS-war/resources/hello/applicationsandoffers?id='+studentId)
	   .set('Authorization', "Basic "+auth)
	   .set('Accept', 'application/json')
	   .end(function(err, response){
	   		if (response != undefined){
...
/*	var resp = {
	...
	//post
	request
	   .get('http://10.32.0.254:8080/IMS-war/resources/hello/offersbypartner?name='+company)
	   .set('Authorization', "Basic "+auth)
	   .set('Accept', 'application/json')
	   .end(function(err, response){
	   		if (response != undefined){
